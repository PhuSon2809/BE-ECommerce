              ...
              >
                {({ open }) => (
                  <div className='relative'>
                    <ListboxButton
                      className={`relative w-full ${size === 'small' ? 'h-[48px]' : 'xs:h-11 sm:h-[52px]'} xs:rounded-[30px] sm:rounded-[32px] py-1.5 pl-3 pr-10 shadow-sm ${variant === 'outline' ? 'bg-white border-[1px] border-solid border-blackMain/[.22] rounded-[30px]' : 'bg-greyLight rounded-lg'} focus:outline-none ${
                        disabled
                          ? 'bg-blackMain/[.03]'
                          : variant === 'outline'
