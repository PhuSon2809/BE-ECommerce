  ...
  return (
    <>
      <section className='relative'>
        ...
        >
          <h1 className='xs:text-[120px] sm:text-[240px] text-white font-customBold leading-[252px] mb-16'>
            WONDERFUL
          </h1>
        </div>
          ...
          <div className='flex flex-col xs:gap-3 sm:gap-5 absolute xs:bottom-[-30%] sm:bottom-[45px] xs:left-[5%] sm:left-[10%] transition-transform duration-300 ease-in-out'>
            ...
            <div className='flex items-center gap-5'>
              <Button
                ...
                className='xs:w-[173px] sm:w-[200px] xs:h-[48px] sm:h-[54px] rounded-[27px]'
              >
                BUY NOW
              </Button>
      ...
      <CartDialog open={isOpen} setOpen={setIsOpen} product={product} />
    </>
  )
}
