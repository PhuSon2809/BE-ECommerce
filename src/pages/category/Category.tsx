...
import { CategoryPopup } from '~/sections/common'
import './styles.scss'
...
function Category() {
  ...
  return (
    <>
          ...
          <div className='flex gap-5'>
            <div className='w-[927px] flex flex-1 flex-col gap-5'>
              ...
              <div
                ...
                style={{ cursor: 'grab' }}
                className='flex items-center gap-[10px] flex-nowrap overflow-auto py-2 -mt-3 -mb-2 list-filter'
              >
      ...
      <CategoryPopup open={openMenu} setOpen={setOpenMenu} />
    </>
  )
}
